...
<form name="userRegistrationForm" method="post" action="/services/processFormData">
   <input type="text" name="zipCode" value="" class ="" style="width:180px;" />
   ...
   <input type="submit" title="Search" class="kpPageSearchButton" style="width:195px;height:30px;" value="Search" name="bttnAction">
</form>
</p>
